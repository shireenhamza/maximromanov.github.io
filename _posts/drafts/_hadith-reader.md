...
<p class="arabic">قَالَ أَبُو مَسْعُودِ.نْ :: أَنَا قَدْ سَمِعْتُ هٰذَا مِنْ رَسُولِ ﭐلـلّٰـهِ ( .سْلْعْمْ ) </p>


<!--@@.hadda_ta-n_a `Amr?u.w bn?u R_afi`?i.n , .hadda_ta-n_a `Abd?u All~ah?i bn?u al-Mub_arak?i , `an Mu.hammad?i bn?i 'Is.h_aq?a , `an Mu.hammad?i bn?i ^Ga`far?i.n , `an `Ubayd?i All~ah?i bn?i `Abd?i All~ah?i bn?i `Umar?a , `an 'Ab_i Hurayra:t?a , `an?i al-Nabiyy?i ( .sl`m ) na.hwa-hu -->
<p class="arabic">.هَدَّثَنَا عَمْرُ.وْ بْنُ رَافِعِ.نْ ، .هَدَّثَنَا عَبْدُ ﭐلـلّٰـهِ بْنُ ﭐلْمُبَارَكِ ، عَنْ مُ.هَمَّدِ بْنِ إِس.هَاقَ ، عَنْ مُ.هَمَّدِ بْنِ جَعْفَرِ.نْ ، عَنْ عُبَيْدِ ﭐلـلّٰـهِ بْنِ عَبْدِ ﭐلـلّٰـهِ بْنِ عُمَرَ ، عَنْ أَبِي هُرَيْرَ:تَ ، عَنِ ﭐلنَّبِيِّ ( .سْلْعْمْ ) نَ.هْوَهُ </p>
